"""
Shipping Cylinder Array Problem Template.

A 3D array of UF6 shipping cylinders arranged in rows × cols × layers.
Uses the ANSI N14.1 cylinder registry for standard dimensions (30B, 48Y, etc.).
...
class ShippingCylinderArrayTemplate(ProblemTemplate):
    """
...
Template = ShippingCylinderArrayTemplate
