...
Use this as the full reviewer-facing template when authoring
...
It should help a criticality safety reviewer understand:
...
This is a model review and traceability package. It is not the final licensing
or NCSE deliverable.
...
Provide the path to the shared material library, generated material helpers,
and any supporting material basis documents.
