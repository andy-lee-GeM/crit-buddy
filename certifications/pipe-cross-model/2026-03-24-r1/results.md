# Pipe Cross Model Certification 2026-03-24-r1

This checkpoint preserves the OpenMC sweep config, lightweight OpenMC outputs,
and rerunnable MCNP case directories used for the `pipe-cross-model`
...
```bash
python run_study.py certifications/pipe-cross-model/2026-03-24-r1/openmc/study.yaml
```

MCNP:

```bash
for case_dir in certifications/pipe-cross-model/2026-03-24-r1/mcnp/sep_*; do
  (
    cd "$case_dir"
